...
var cards = {
	"Liliana Vess, Necromancer":{
		...
		"defense":3,
		"abilityArray":[
			{"title":"Zombie Toughness","body":"All Zombies you control within 4 clear sight spaces of Liliana get +1#{aotp aotp-defense}."},
	...
	"Kor Aeronaught Captain":{
		...
		"cost":100,
		"artist":{"iconClass":"aotp aotp-artist-pawn", "title":"Lu Hua"},
	...
	"Chandra Nalaar, Pyromancer":{
		...
		"cost":365,
		"artist":{"iconClass":"aotp aotp-artist-pawn", "title":""},
		"copyRight":"&copy; 2014 Hasbro TM & &copy; 2014 Wizards"
	},
	"Eldrazi Ruiner":{
		"colors":[],
		...
		"cost":150,
		"artist":{"iconClass":"aotp aotp-artist-pawn", "title":"Raymond Swanland"},
		"copyRight":"&copy; 2015 Hasbro TM & &copy; 2015 Wizards"
	}
}
